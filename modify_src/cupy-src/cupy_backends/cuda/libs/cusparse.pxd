...
cdef extern from *:
    ctypedef void* cusparseConstSpMatDescr_t
    ...
    Status cusparseSpGEMM_getNumProducts(SpGEMMDescr spgemmDescr, int64_t* numProducts)
...
cdef extern from "cusparse.h":
    Status cusparseSpGEMM_estimateMemory(
        ...
        SpGEMMAlg alg, SpGEMMDescr spgemmDescr, float chunk_fraction,
        size_t* bufferSize3, void* externalBuffer3, size_t* bufferSize2) nogil

...
cpdef size_t spGEMM_estimateMemory_getBuf3(
        ...
        DataType computeType, int alg, intptr_t spgemmDescr,
        float chunk_fraction) except? -1:
    cdef size_t bufferSize3 = 0
    status = cusparseSpGEMM_estimateMemory(
        <Handle>handle, opA, opB, <const void*>alpha,
        <cusparseConstSpMatDescr_t>matA,
        <cusparseConstSpMatDescr_t>matB,
        <const void*>beta,
        <SpMatDescr>matC,
        computeType, <SpGEMMAlg>alg, <SpGEMMDescr>spgemmDescr,
        <float>chunk_fraction,
        &bufferSize3, <void*>0, <size_t*>0)
    check_status(status)
    return bufferSize3
...
cpdef size_t spGEMM_estimateMemory(
        ...
        intptr_t matA, intptr_t matB, intptr_t beta, intptr_t matC,
        DataType computeType, int alg, intptr_t spgemmDescr,
        float chunk_fraction, size_t bufferSize3, intptr_t externalBuffer3) except? -1:
    cdef size_t bufferSize2 = 0
    status = cusparseSpGEMM_estimateMemory(
        <Handle>handle, opA, opB, <const void*>alpha,
        <cusparseConstSpMatDescr_t>matA,
        <cusparseConstSpMatDescr_t>matB,
        ...
        computeType, <SpGEMMAlg>alg, <SpGEMMDescr>spgemmDescr,
        <float>chunk_fraction,
        &bufferSize3, <void*>externalBuffer3, &bufferSize2)
    check_status(status)
    return bufferSize2
